package com.example.techshop.iam.infraestructure.token.jwtd.services;
...
public class TokenServiceImpl implements BearerTokenService {
    ...
    @Override
    public String generateToken(Authentication authentication) {return buildTokenWithDefaultParameters(authentication.getName());}
